...
enum Scenario {
  ...
  var title: String {
    ...
    case .exportComponent: return "导出组件"
    case .sourceComponent: return "数据来源"
    }
  }
  ...
  var subtitle: String {
    ...
    case .exportComponent: return "InkComponentBlock 导出样式"
    case .sourceComponent: return "InkComponentBlock 数据来源样式"
    }
  }
}
