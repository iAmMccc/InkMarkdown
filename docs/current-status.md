...
| CI 构建 | 建立 iOS Simulator 自动测试 | 统一使用 Xcode 26.6 + iPhone 17 Pro/OS 26.5；Core、SwiftUI、addon contract/LaTeX、Mermaid 与 ExampleApp Debug/Release 已拆为独立 job | 最终候选 SHA 必须通过全部必要 job；镜像升级时同步配置与排坑文档 |
